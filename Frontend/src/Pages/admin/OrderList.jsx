  ...
  return (
    <div>
      <div className="mb-5 d-flex align-items-center justify-content-between">
        <h3 className="fw-bold" style={{ color: "#7d7d7d" }}>
          Order List
        </h3>
        <a
          className="d-block p-3 link-body-emphasis text-decoration-none bg-white d-flex align-items-center gap-1 dropdown-toggle"
        ...
        <table className="table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div
                  className="pt-2 d-flex flex-column text-primary"
              ...
              <td>
                <div className="pt-2 h-100 d-flex flex-column">RFG-10</div>
              </td>
              <td>
              ...
              <td className="">
                <div className="pt-2 h-100 d-flex flex-column">
                  <span className="fw-bold" style={{ color: "#ff806f" }}>
                    Pending
                  </span>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div className="pt-2 h-100 d-flex flex-column">RFG-05</div>
              </td>
              <td>
                <div className="pt-2 h-100 d-flex flex-column">
                  <small>
              ...
              <td className="">
                <div className="pt-2 h-100 d-flex flex-column">
                  <span className="fw-bold" style={{ color: "#77da7e" }}>
                    Completed
                  </span>
                </div>
              </td>
